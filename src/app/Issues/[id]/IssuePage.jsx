...
export default function IssuePage() {
  ...
  // Effect to wait for params to be loaded
  useEffect(() => {
    if (params?.id) {
      console.log("[IssuePage] Params loaded with ID:", params.id);
      setParamsLoaded(true);
    }
  }, [params]);

  // Effect to fetch issue once params are loaded
  useEffect(() => {
    if (!paramsLoaded || !params?.id) {
      return;
    }
    ...
    const fetchIssue = async () => {
      try {
        ...
        console.log("[IssuePage] Fetching issue with ID:", issueId);
        ...
        console.log("[IssuePage] Issue fetched successfully:", data);
        setIssue(data);
      } catch (error) {
        console.error("[IssuePage] Fetch error:", error);
